...
- [ ] Run `uv run python tools/evaluate_calibration_models.py metrics/demo.jsonl --screen-width 1512 --screen-height 982 --grid-columns 4 --grid-rows 3` with the screen dimensions from the manual run and confirm it ranks candidate calibration models.
